...
const InventarioPrivadoForm = () => {
  ...
  const { inventarioPrivado } = useMovimiento();
  ...
  const handleEntrarSubmit = async (e) => {
    ...
    try {
      const result = await inventarioPrivado(newMovimiento);
...
export default InventarioPrivadoForm;