...
const ListaPrivado = () => {
  const { getMedicamentosPrivado, editoMedicamento } = useMedicamento();
  ...
  const loadMedicamentos = async () => {
    try {
      const data = await getMedicamentosPrivado();
 ...
 const sortMedicamentos = () => {
  const sortedMedicamentos = [...medicamentos].sort((a, b) => {
    if (orderField === 'stock') {
      return orderDirection === 'asc' ? a.stockPriv - b.stockPriv : b.stockPriv - a.stockPriv;
  ...
  return (
    <div>
          ...
          <div className="">
            <p className="text-center text-primary fs-1">Stock Privado</p>
          <div className="">
        ...
        <form className="edit-form">
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <div className="input-value">{editMedicamento.stockPriv}</div>
            </div>
          </div>
