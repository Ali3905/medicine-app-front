...
const InventarioForm = () => {
  ...
  const { nuevoInventario } = useMovimiento();
  ...
  const handleEntrarSubmit = async (e) => {
    ...
    try {
      const result = await nuevoInventario(newMovimiento);
    ...
    <div>
     <div className='text-center mb-3 '>
      ...
      <table className="table table-striped table-hover text-sm text-left p-3 col-6">
          ...
          <th scope="col" className="px-6 py-2">Açoes</th>
          </tr>
        </thead>
        <tbody>
